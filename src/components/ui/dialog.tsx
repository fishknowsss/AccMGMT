...
export function Dialog({ title, children, footer, onClose, className }: DialogProps) {
  ...
  return (
    <div className="dialog-overlay fixed inset-0 z-50 flex justify-end bg-[#121417]/28 p-3" onMouseDown={handleOverlayClick} role="presentation">
      <section
        aria-modal="true"
        className={cn(
          'dialog-panel flex h-full w-full max-w-[520px] flex-col overflow-hidden rounded-[18px] border border-[#DDE3EA] bg-white shadow-[0_28px_90px_rgba(25,27,31,0.22)]',
          className,
        )}
        role="dialog"
      >
